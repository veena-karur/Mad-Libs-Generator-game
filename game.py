...
def story1():
    ...
    print("As I reached home, I realised that I had forgotten the "+thing+". There was still an hour for my "+relation+" to turn up ."
          "So I decided "+place+" to enjoy the cool breeze . Just as I reached the "+place+", I received a call on my mobile phone from "+friend +
...
def story3():
    ...
    print("It was dark and lonely night . I was returning from a"+person+"'s place and missed the last"+vehicle+" going towards my home . Now , I had to walk through "
          "the jungle . I was "+adjective+" , but the thought of reaching home on yime persuaded me ."
          ...
          " suddenly , I heard the sound of "+sound+". I suspected whether I waas alone . I followed the sound of these "+sound+". It was like light at the end of a "+place+
